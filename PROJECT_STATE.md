# PROJECT_STATE — «Лавка чудес: Магия зелий»
...
**Базовый формат:** landscape 16:9, ПК + mobile
...
## 2. РАБОЧЕЕ НАЗВАНИЕ И СЕТТИНГ

Рабочее название: **«Лавка чудес: Магия зелий»**.
...
- магазин;
- попапы;
- экран/плашки коллекции персонажей, если механика будет перенесена;
- промо-арт;
- иконка;
